...
#include "TouVerbMessageHelpers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TouVerbMessageHelpers)

//////////////////////////////////////////////////////////////////////
// FTouVerbMessage

FString FTouVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FTouVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UTouVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UTouVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UTouVerbMessageHelpers::VerbMessageToCueParameters(const FTouVerbMessage& Message)
{
...
FTouVerbMessage UTouVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FTouVerbMessage Result;
