...
#include "TouUserFacingExperienceDefinition.generated.h"
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="TouExperienceDefinition"))
