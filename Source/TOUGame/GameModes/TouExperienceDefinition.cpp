...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TouExperienceDefinition)

#define LOCTEXT_NAMESPACE "TouSystem"

UTouExperienceDefinition::UTouExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UTouExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UTouExperienceDefinition::UpdateAssetBundleData()
{
