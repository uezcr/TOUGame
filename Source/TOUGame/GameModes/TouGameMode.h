...
#include "TouGameMode.generated.h"
 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnTouGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class ATouGameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	ATouGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "Tou|Pawn")
	const UTouPawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnTouGameModePlayerInitialized OnGameModePlayerInitialized;
