...
#include "TouCosmeticAnimationTypes.generated.h"
...
struct FTouAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTouAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FTouAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FTouAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTouAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FTouAnimBodyStyleSelectionEntry> MeshRules;
