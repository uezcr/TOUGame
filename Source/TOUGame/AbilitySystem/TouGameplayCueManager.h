...
#include "TouGameplayCueManager.generated.h"
...
UCLASS()
class UTouGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UTouGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UTouGameplayCueManager* Get();
