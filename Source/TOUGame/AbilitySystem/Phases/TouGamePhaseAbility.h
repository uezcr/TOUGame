...
#include "TouGamePhaseAbility.generated.h"

/**
 * UTouGamePhaseAbility
 *
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class UTouGamePhaseAbility : public UTouGameplayAbility
{
	GENERATED_BODY()

public:

	UTouGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Tou|Game Phase")
