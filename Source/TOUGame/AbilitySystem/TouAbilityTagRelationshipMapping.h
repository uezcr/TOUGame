...
#include "TouAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FTouAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UTouAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FTouAbilityTagRelationship> AbilityTagRelationships;
