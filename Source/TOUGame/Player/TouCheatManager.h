...
#include "TouCheatManager.generated.h"
...
DECLARE_LOG_CATEGORY_EXTERN(LogTouCheat, Log, All);
...
class UTouCheatManager : public UCheatManager
{
	GENERATED_BODY()
...
protected:
	...
	void ApplySetByCallerDamage(UTouAbilitySystemComponent* TouASC, float DamageAmount);
	void ApplySetByCallerHeal(UTouAbilitySystemComponent* TouASC, float HealAmount);

	UTouAbilitySystemComponent* GetPlayerAbilitySystemComponent() const;
};
