...
#include "TouPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "TouCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UTouCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UTouCameraMode_ThirdPerson : public UTouCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FTouPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
