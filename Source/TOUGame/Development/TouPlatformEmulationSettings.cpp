...
#include "TouPlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TouPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "TouCheats"

UTouPlatformEmulationSettings::UTouPlatformEmulationSettings()
{
}

FName UTouPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UTouPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UTouPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UTouPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UTouPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UTouPlatformEmulationSettings::PostInitProperties()
{
...
void UTouPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UTouPlatformEmulationSettings::ApplySettings()
{
...
void UTouPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UTouPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UTouPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UTouPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
