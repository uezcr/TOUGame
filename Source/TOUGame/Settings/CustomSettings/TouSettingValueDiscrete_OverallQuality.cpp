...
#include "TouSettingValueDiscrete_OverallQuality.h"

#include "Engine/Engine.h"
#include "Settings/TouSettingsLocal.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(TouSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "TouSettings"

UTouSettingValueDiscrete_OverallQuality::UTouSettingValueDiscrete_OverallQuality()
{
}

void UTouSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();

	UTouSettingsLocal* UserSettings = UTouSettingsLocal::Get();
...
void UTouSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void UTouSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void UTouSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void UTouSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UTouSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> UTouSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 UTouSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 UTouSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
