...
#include "TouSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UTouSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UTouSettingValueDiscrete_Resolution();
