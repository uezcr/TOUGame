...
#include "TouSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TouSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "TouSettings"

UTouSettingValueDiscrete_Resolution::UTouSettingValueDiscrete_Resolution()
{
}

void UTouSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UTouSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UTouSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UTouSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UTouSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UTouSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UTouSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UTouSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UTouSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UTouSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UTouSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UTouSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UTouSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UTouSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UTouSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UTouSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
