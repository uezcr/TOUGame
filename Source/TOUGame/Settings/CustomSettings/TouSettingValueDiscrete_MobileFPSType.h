...
//#include "Settings/TouMobilePerformance.h"
#include "GameSettingValueDiscrete.h"

#include "TouSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class UTouSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UTouSettingValueDiscrete_MobileFPSType();
