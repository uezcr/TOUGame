...
#include "TouSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class UTouSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~UTouSettingValueDiscreteDynamic_AudioOutputDevice() = default;
