...
#include "TouSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UTouSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UTouSafeZoneEditor(const FObjectInitializer& Initializer);
