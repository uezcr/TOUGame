...
#include "TouBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UTouBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UTouBrightnessEditor(const FObjectInitializer& Initializer);
