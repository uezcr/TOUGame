...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TouBrightnessEditor)
...
UTouBrightnessEditor::UTouBrightnessEditor(const FObjectInitializer& Initializer)
	: Super(Initializer)
{
...
void UTouBrightnessEditor::NativeOnInitialized()
{
	Super::NativeOnInitialized();
	Switcher_SafeZoneMessage->SetActiveWidget(RichText_Default);
}

void UTouBrightnessEditor::NativeOnActivated()
{
...
bool UTouBrightnessEditor::ExecuteActionForSetting_Implementation(FGameplayTag ActionTag, UGameSetting* InSetting)
{
...
FReply UTouBrightnessEditor::NativeOnAnalogValueChanged(const FGeometry& InGeometry, const FAnalogInputEvent& InAnalogEvent)
{
...
FReply UTouBrightnessEditor::NativeOnMouseWheel(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
...
void UTouBrightnessEditor::HandleInputModeChanged(ECommonInputType InInputType)
{
...
void UTouBrightnessEditor::HandleBackClicked()
{
	DeactivateWidget();
	SSafeZone::SetGlobalSafeZoneScale(UTouSettingsLocal::Get()->GetSafeZone());
}

void UTouBrightnessEditor::HandleDoneClicked()
{
