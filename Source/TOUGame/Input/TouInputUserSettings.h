...
#include "TouInputUserSettings.generated.h"

/** 
 * Custom settings class for any input related settings for the Tou game.
 * This will be serialized out at the same time as the Tou Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class TOUGAME_API UTouInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class TOUGAME_API UTouPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
