...
#include "TouRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UTouRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UTouRangedWeaponInstance : public UTouWeaponInstance,public ITouAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UTouRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~UTouEquipmentInstance interface
	virtual void OnEquipped();
	virtual void OnUnequipped();
	//~End of UTouEquipmentInstance interface

	void AddSpread();

	//~ITouAbilitySourceInterface interface
	...
	//~End of ITouAbilitySourceInterface interface
