...
#include "TouWeaponInstance.generated.h"
 ...
 */
UCLASS()
class UTouWeaponInstance : public UTouEquipmentInstance
{
	GENERATED_BODY()

public:
	UTouWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	FTouAnimLayerSelectionSet EquippedAnimSet;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Animation)
	FTouAnimLayerSelectionSet UneuippedAnimSet;
