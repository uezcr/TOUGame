...
class UTouPawnExtensionComponent;
class UObject;
struct FFrame;
struct FGameplayTag;
...
/**
 * FTouReplicatedAcceleration: Compressed representation of acceleration
 */
USTRUCT()
...
public:
	...
	ATouCharacter(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
