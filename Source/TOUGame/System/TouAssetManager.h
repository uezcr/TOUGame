...
#include "TouAssetManager.generated.h"
...
public:
	...
	const UTouGameData& GetGameData();
	const UTouPawnData* GetDefaultPawnData() const;
...
protected:
	...
	UPROPERTY(Config)
	TSoftObjectPtr<UTouPawnData> DefaultPawnData;
...
private:
	...
	TArray<FTouAssetManagerStartupJob> StartupJobs;
...
template<typename AssetType>
AssetType* UTouAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
...
template<typename AssetType>
TSubclassOf<AssetType> UTouAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
