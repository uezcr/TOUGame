...
#include "TouSystemStatics.generated.h"
...
UCLASS()
class UTouSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="Tou", meta = (WorldContext = "WorldContextObject"))
